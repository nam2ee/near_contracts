export declare enum EDataVersion {
    initial = "0",
    _2022112400 = "2022112400"
}
export declare enum EMeteorAnalytics_EventType {
    test = "test",
    page_view = "page_view",
...
export declare enum EMeteorAnalytics_SubType_WalletAction {
    send_near = "send_near",
    send_ft = "send_ft",
    send_nft = "send_nft",
    swap = "swap",
...
export declare enum EMeteorAnalytics_SubType_UserAction {
    unlock = "unlock",
...
export declare enum EMeteorAnalytics_AppReleaseEnvironment {
    dev_local = "dev_local",
    dev_live = "dev_live",
