...
export type TNearAction = TNearAction_CreateAccount | INearAction_FunctionCall | INearAction_AddKey | INearAction_DeleteKey | INearAction_DeleteAccount | INearAction_Stake | INearAction_Transfer | INearAction_DeployContract;
...
export declare enum EGasCostType {
...
export declare enum EGasCostCategory {
...
export type TNearExecutionOutcomeStatus_Success = INearExecutionOutcomeStatus_SuccessValue | INearExecutionOutcomeStatus_SuccessReceiptId;
export type TNearExecutionOutcomeStatus = TNearExecutionOutcomeStatus_Success | INearExecutionOutcomeStatus_Failure;
...
export declare enum ENearProofDirection {
    Right = "Right",
    Left = "Left"
}
...
export declare enum INear_FinalExecutionStatusBasic {
    NotStarted = "NotStarted",
    Started = "Started",
    Failure = "Failure"
}
export declare enum INear_ExecutionStatusBasic {
    Unknown = "Unknown",
    Pending = "Pending",
    Failure = "Failure"
}
