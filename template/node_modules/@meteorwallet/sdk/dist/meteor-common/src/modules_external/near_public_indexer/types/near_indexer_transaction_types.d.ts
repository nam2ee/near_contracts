...
export declare enum ENearIndexer_TransactionStatus {
...
export declare enum ENearIndexer_ActionKind {
...
export interface INearIndexer_TransactionAction_Any<TArgs = any> extends INearIndexer_TransactionAction_Base {
    action_kind: ENearIndexer_ActionKind;
    args: TArgs;
}
export type TNearIndexer_TransactionAction = INearIndexer_TransactionAction_Base & TNearIndexer_TransactionAction_Stripped;
...
export type TFtTransferActionArgs = INearIndexer_ActionArgs_FunctionCall<EFunctionCallMethod_FungibleTokenStandard.ft_transfer, IFCActionArgsJson_FtTransfer>;
export type TNftTransferActionArgs = INearIndexer_ActionArgs_FunctionCall<ENearFunctionCallMethod_NftStandard.nft_transfer, IFCActionArgsJson_NftTransfer>;
export interface INearIndexer_ActionArgs_FunctionCall<TName extends string = string, TActionArgsJson extends IFCActionArgsJson = any> {
    gas: string;
    deposit: string;
    method_name: TName;
